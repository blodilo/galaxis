...
**Projektstatus:** AP1 + AP2 implementiert und lauffähig · God-Mode-Viewer · Image-Based Generator · Systemansicht mit prozeduralen Shadern, Prominenzen, Layer-System, Mondsystem-Ansicht, InstancedMesh-Asteroiden · Vitest-Test-Infrastruktur eingerichtet · Wirtschaftsmodell v1.0 + Produktionsmechanik v1.0 finalisiert
**GDD-Version:** v1.24
**Datum:** 2026-03-22
...
|---|---|---|
| `dokumentenregister_v1.1.md` | Projektstatus-Übersicht | ✅ aktuell |
...
| `game-params_v1.5.yaml` | Zentrale Spielparameter (Kalibrierung, Balancing, Performance-Limits) | ✅ aktuell |
...
| `game-params_v1.5.yaml` | Zentrale Spielparameter inkl. neuem `production:`-Block | ✅ aktuell |
